package dev.jmvg.maxmovies.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.bumptech.glide.Glide
import dev.jmvg.maxmovies.api.TheMoviesAPI.BASE_IMAGE_URL
...
class MovieAdapter(val movieClickListener: (Int) -> Unit):
  ...
  override fun onBindViewHolder(holder: ViewHolder, position: Int) {
      ...
      Glide.with(holder.binding.root).load("${BASE_IMAGE_URL}${item.posterPath}")
